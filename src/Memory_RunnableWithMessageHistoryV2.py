...
# 加 RunnableConfig 类型注解：否则会被推断为 dict[str, dict[str, str]]，pyright 报类型错
cfg_user_001: RunnableConfig = {"configurable": {"session_id": "user-001"}}
cfg_user_002: RunnableConfig = {"configurable": {"session_id": "user-002"}}
